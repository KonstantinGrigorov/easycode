...
class MainController extends BehaviorsController
{
    ...
    {
    	$hello = 'Пожалуйста, войдите под своим именем или зарегистрируйтесь)';
    ...
    public function actionActivateAccount($key)
    {
        ...
        if($user->activateAccount()):
            Yii::$app->session->setFlash('success', 'Активация прошла успешно. <strong>'.Html::encode($user->username).'</strong> вы теперь c нами)!!!');
        else:
    ...
    {   
        ...
        //return $this->redirect(['/main/succesLogin']);
    }
